...
diabetes_model = pickle.load(open("Trained_model_Diabetes_final.sav", 'rb'))
...
if (selected == 'Diabetes Prediction'):
    ...
    with col3:
        heart_disease = st.text_input('heart_disease(0 or 1)')
...
if (selected == 'Heart Disease Prediction'):
    ...
    with col3:
        cp = st.text_input('Chest Pain types(type-1 to 4)')
